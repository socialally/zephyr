...
To run the tests in a browser context open [test/index.html](https://github.com/tempfs/zephyr/blob/master/test/index.html) or use the server `npm start`.
...
Everything is [MIT](http://en.wikipedia.org/wiki/MIT_License). Read the [license](https://github.com/tempfs/zephyr/blob/master/LICENSE) if you feel inclined.
